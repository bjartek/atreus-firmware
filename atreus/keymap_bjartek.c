...
const uint16_t PROGMEM actionmaps[][MATRIX_ROWS][MATRIX_COLS] = {
  KEYMAP( /* 0: mostly letters */
    ...
    TAP(7,Z),        X,        C,         V,         B,    /*|,, |*/             N,   M,       COMM, DOT,  SLSH, \
  ...
  KEYMAP( /* trying out new layer 2 as layer 7 for now lots of idea shortcute on left, not sure how much i will use them.*/
    ...
    OFF(7), TAB,     OSM(LGUI), OSM(LSFT), CS, OSM(LCTL), OSM(LALT), AS,    AC,       MINS,     SH(2),     TAPK(RALT,ENT)
  ),
};
